...
exports.run = async (client, msg, args) => {
    ...
    request(`https://djs-bot-list.glitch.me/api/botlar/${args[0]}`, function (error, response, body) {
    if (error) return msg.channel.send('Hata:', error);
      ...
      request(`https://botlarlistesi.glitch.me/api/tumbotlar`, function (errorr, responsee, bodyy) {
    ...
    .setFooter('sisteminde bot aramaktadır.')
